package net.cryls.backendcursojava.security;
...
public class WebSecurity extends WebSecurityConfigurerAdapter{
    ...
    public WebSecurity(UserServiceInterface userService, BCryptPasswordEncoder bCryptPasswordEncoder){
        ...
        this.bcCryptPasswordEncoder = bCryptPasswordEncoder;
...
@Override
    ...
    public void configure(AuthenticationManagerBuilder auth)throws Exception {
        auth.userDetailsService(userServiceInterface).passwordEncoder(bcCryptPasswordEncoder);
    }
}
